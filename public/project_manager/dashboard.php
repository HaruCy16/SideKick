...
$user = require_auth_page('manager');
?>
...
<head>
    ...
    <title>Dashboard - Project Manager | SideKick</title>
...
<body class="bg-gray-100">
    <!-- Sidebar -->
    <?php $current_role = 'project_manager'; $current_page = 'dashboard'; include '../../includes/sidebar.php'; ?>
    ...
    <?php $current_role = 'manager'; $current_page = 'dashboard'; include '../../includes/sidebar.php'; ?>
    ...
    <div class="ml-64 min-h-screen">
        ...
        <main class="p-6">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400">Projects and team management overview</p>
            </div>

            <!-- Stats Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <?php
                // Stat card data for project manager
                $stats_data = [
                    ['label' => 'Projects', 'icon' => 'folder-open', 'color' => '#14B8A6', 'bg' => '#CCFBF1'],
                    ['label' => 'Tasks', 'icon' => 'list-check', 'color' => '#8B5CF6', 'bg' => '#EDE9FE'],
                    ['label' => 'Team Members', 'icon' => 'users', 'color' => '#EC4899', 'bg' => '#FCE7F3'],
                    ['label' => 'Hours Logged', 'icon' => 'clock', 'color' => '#F59E0B', 'bg' => '#FEF3C7'],
                ];
            ...
            <div class="bg-white dark:bg-[#1A1A2E] rounded-xl p-6 border border-gray-100 dark:border-[#2D2D44] shadow-sm">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Team Tasks</h2>
