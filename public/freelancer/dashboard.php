...
$user = require_auth_page('freelancer');
?>
...
<head>
    ...
    <title>Dashboard - Freelancer | SideKick</title>
...
<body class="bg-gray-100">
    <!-- Sidebar -->
    <?php $current_role = 'freelancer'; $current_page = 'dashboard'; include '../../includes/sidebar.php'; ?>
    ...
    <div class="ml-64 min-h-screen flex flex-col">
        ...
        <main class="flex-1 pt-16 p-6 flex flex-col gap-5">
            ...
            <div class="flex flex-col">
                ...
                <p class="text-sm text-gray-500 mt-1">Welcome back! Here's your performance overview.</p>
            </div>
            ...
            <div class="grid grid-cols-4 gap-4">
                <?php
                $stats_data = [
                    ['label' => 'Active Tasks', 'color' => '#14B8A6', 'bg' => '#CCFBF1'],
                    ['label' => 'Completed', 'color' => '#8B5CF6', 'bg' => '#EDE9FE'],
                    ['label' => 'This Week', 'color' => '#EC4899', 'bg' => '#FCE7F3'],
                    ['label' => 'Earnings', 'color' => '#F59E0B', 'bg' => '#FEF3C7'],
                ];
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                ...
                <div class="bg-gray-200 rounded-2xl p-5">
                    <div class="flex items-center justify-between mb-4">
                        <p class="text-sm font-semibold text-gray-800">Recent Tasks</p>
                ...
                <div class="bg-gray-400 rounded-2xl p-5">
                    <p class="text-sm font-semibold text-white text-center mb-4">Activity</p>
    ...
    <div class="ml-64 min-h-screen">
        ...
        <main class="p-6">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400">Welcome back! Here's your work summary.</p>
            </div>

            <!-- Stats Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <?php
                // Stat card data for freelancer
                $stats_data = [
                    ['label' => 'Active Tasks', 'icon' => 'play-circle', 'color' => '#14B8A6', 'bg' => '#CCFBF1'],
                    ['label' => 'Completed', 'icon' => 'check-circle', 'color' => '#8B5CF6', 'bg' => '#EDE9FE'],
                    ['label' => 'Hours This Week', 'icon' => 'hourglass-end', 'color' => '#EC4899', 'bg' => '#FCE7F3'],
                    ['label' => 'Earnings', 'icon' => 'wallet', 'color' => '#F59E0B', 'bg' => '#FEF3C7'],
                ];
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', fetchDashboardData);
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-slate-600 dark:text-slate-400">Active Tasks</p>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm border border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-900 dark:text-white mt-2">24</p>
                        </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm border border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-slate-600 dark:text-slate-400">Total Earnings</p>
                            <p class="text-3xl font-bold text-slate-900 dark:text-white mt-2">$2,450</p>
                        </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm border border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-slate-600 dark:text-slate-400">Hours Logged</p>
                            <p class="text-3xl font-bold text-slate-900 dark:text-white mt-2">156</p>
                        </div>
                        <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center text-2xl">⏱️</div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <!-- Left Column: Recent Tasks + My Tasks -->
                <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="pb-6 border-b border-slate-200 dark:border-slate-700 last:border-b-0">
                                <div class="flex items-start justify-between mb-3">
                                    <div>
                                        <h3 class="font-semibold text-slate-900 dark:text-white">E-commerce Website</h3>
                                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Frontend Development</p>
                                    </div>
                                ...
                                <p class="text-xs text-slate-600 dark:text-slate-400 mt-2">65% complete</p>
                            </div>
                            ...
                            <div class="pb-6 border-b border-slate-200 dark:border-slate-700 last:border-b-0">
                                <div class="flex items-start justify-between mb-3">
                                    <div>
                                        <h3 class="font-semibold text-slate-900 dark:text-white">Mobile App UI</h3>
                                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">UI/UX Design</p>
                                    </div>
                            ...
                            <div>
                                <div class="flex items-start justify-between mb-3">
                                    <div>
                                        <h3 class="font-semibold text-slate-900 dark:text-white">API Integration</h3>
                                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Backend Development</p>
                                    </div>
                                    <span class="px-3 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 text-xs font-semibold rounded-full">On Hold</span>
                                </div>
                                <div class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                                    <div class="bg-amber-500 h-2 rounded-full" style="width: 30%"></div>
                                </div>
                                <p class="text-xs text-slate-600 dark:text-slate-400 mt-2">30% complete</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700">
                            <h2 class="text-lg font-semibold text-slate-900 dark:text-white">My Tasks</h2>
                        </div>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="font-medium text-slate-900 dark:text-white">Fix login page bugs</p>
                                                <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">E-commerce Website</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3">
                                            <input type="checkbox" class="rounded" />
                                            <div>
                                                <p class="font-medium text-slate-900 dark:text-white">Review pull requests</p>
                                                <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">Mobile App UI</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 ml-4">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">API Integration</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 ml-4">
                                        ...
                                        <span class="text-xs text-slate-600 dark:text-slate-400">Mar 20</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3">
                                            <input type="checkbox" class="rounded" />
                                            <div>
                                                <p class="font-medium text-slate-900 dark:text-white">Client meeting preparation</p>
                                                <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">General</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 ml-4">
                            ...
                            <div class="px-6 py-4">
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-slate-600 dark:text-slate-400">Completed task "Dashboard UI"</p>
                            ...
                            <div class="px-6 py-4">
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-slate-600 dark:text-slate-400">Updated project timeline</p>
                            ...
                            <div class="px-6 py-4">
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-slate-600 dark:text-slate-400">Commented on API documentation</p>
                            ...
                            <div class="px-6 py-4">
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-slate-600 dark:text-slate-400">Created new sprint board</p>
