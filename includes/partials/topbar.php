...
<nav class="sticky top-0 z-40 bg-white border-b border-gray-100 h-16 flex items-center px-6 gap-4 shadow-sm ml-64 w-[calc(100%-256px)]">
    <!-- Search -->
    ...
    <!-- Theme Toggle -->
    <button id="themeToggle" class="p-2 text-gray-500 hover:text-gray-900 transition-colors">
